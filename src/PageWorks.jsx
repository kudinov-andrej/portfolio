...
function PageWorks(props) {
  ...
  const works = [
    ...
    },
    {
      ...
      discription: "Один из первых учебных проектов. Его цель - научить строить адаптивные сайты, отработать построение gred сеток. Несмотря на свою простоту, проект получился достаточно интересным и информативным за счет внешних ссылок.", href: "https://kudinov-andrej.github.io/russian-travel/"
    },
    {
      id: 6,
      link: todoImg,
